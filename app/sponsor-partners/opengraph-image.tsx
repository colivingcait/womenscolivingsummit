...
export const alt = "Sponsor the Women's Coliving Summit 2026 — Atlanta, October 16–17";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>Women&apos;s Coliving Summit</span>
          <span style={{ width: 6, height: 6, background: '#DCBE7B', borderRadius: 6, display: 'flex' }} />
          <span>Atlanta 2026</span>
        </div>
        ...
        >
          Reach ~150 women-led coliving operators &amp; investors.
        </div>
      </div>
    ),
    {
