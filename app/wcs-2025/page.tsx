    ...
    <>
      ...
      <section className="cta-band bg-wine">
        <div className="si rv">
          ...
          <div className="cg">
            <a href="https://www.eventbrite.com/e/the-womens-coliving-summit-atlanta-2026-tickets-1986277433272?aff=oddtdtcreator" target="_blank" rel="noreferrer" className="btn btn-g">Get My 2026 Ticket</a>
